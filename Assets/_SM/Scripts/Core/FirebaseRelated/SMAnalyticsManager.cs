...
namespace SM_Core
{
    public class SMAnalyticsManager
    {
        ...
        public void ReportEvent(SMEventType eventType)
        {
            ReportEvent(eventType, new Dictionary<SMDataKeys, object>());
        }

        public void ReportEvent(SMEventType eventType, Dictionary<SMDataKeys, object> data)
        {
